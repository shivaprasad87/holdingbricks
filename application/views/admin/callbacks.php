        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="abc" hidden class="row">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <textarea class="form-control" name="notesClient" id="c_notesClient" rows="18" id="comment">
                            ...
                            With reference to your site visit on  assisted by Mr. abhishek from Holding Bricks, we thank you for giving us an opportunity to serve you in searching your dream home.  At FBP it is our endeavour to help you with all the possible Property options which will suit your requirement. Mr.  from FBP will be at your service. He/she will be there to assist you in searching your dream home.
                            ...
                            Team Holding Bricks Services Pvt Ltd
                ...
                <div class="col-sm-3 form-group">
                    ...
                    <input type="text" class="form-control" id="m_city" name="m_city" placeholder="City" value="" required="">
                  
                </div>
                <div class="col-sm-3 form-group">
                    <label for="m_location">Location:</label>
                    <input type="text" class="form-control" id="m_location" name="m_location" placeholder="budget in lacs or crores*" value="" required="">
                ...
                <div class="col-sm-3 form-group">
                    ...
                    <select  class="form-control"  id="m_client_type" name="client_type">
                                <option value="">Select</option>  
...
<script type="text/javascript">
    ...
    function edit(v){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('#m_budget').val(data.budget);
                $('#m_city').val(data.city);
                $('#m_location').val(data.location);
                $('#m_p_type').val(data.p_type);
                $('#m_possesion').val(data.possesion);
                $('#m_a_services').val(data.a_services);
                $('#m_tos').val(data.tos);
                $('#m_client_type').val(data.client_type); 
    ...
    var notesClient = "Greetings From Holding Bricks.\n\nWith reference to your site visit on {site_visit_date} assisted by Mr. {site_assigned_by} from Holding Bricks, we thank you for giving us an opportunity to serve you in searching your dream home.  At FBP it is our endeavour to help you with all the possible Property options which will suit your requirement. Mr. {relationship_manager} from FBP will be at your service. He/she will be there to assist you in searching your dream home.\n\n1. Home search - Assisting and helping you find your dream home suiting your requirements by giving you info on market trends, legalities, site visit assistance etc.\n\n2. Home loan Assistance - We will take away your pain of running around the banks to get your loan approved by giving doorstep service of bankers of your choice at your place.\n\n3. Property Purchase Assistance - Ensuring that your home buying becomes a pleasant experience our Relationship Manager will be there throughout the process Of documentation.\n\n4. Post sales Service – This is what differentiates us from others. We will be there for all possible help and guidance till you move into your home.\n\n5. Interior Services - We are tied With best interior designers in the city who give the best designs and execute them at a competitive price.\n\n6. Rental Services - Need to rent your house Or searching for good house on rent do not worry try Holding Bricks rental services. Our professional and need based approach will ensure that you get right home/tenant without much hassles.\n\nFor any escalations/ complaints please write to admin@leads.com\n\nRegards\n\nTeam Holding Bricks Services Pvt Ltd";
...
<!--/tabs-->
									 ...
									 <!--footer section start-->
										<footer>
										   <p>&copy <?= date('Y')?> Holding Bricks . All Rights Reserved | Design by <a href="https://secondsdigital.com/" target="_blank">Holding Bricks.</a></p>
										</footer>
									<!--footer section end-->
								</div>
							</div>
