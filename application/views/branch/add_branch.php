            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body mt-3">
                 <?php $attributes = array('class' => 'common_valid'); echo form_open("branch/new_branch",$attributes); ?>
                     
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Branch Name <span class="text-danger">*</span></label>
                          <input type="text" class="form-control  validate[required] "  id="branch_name" name="branch[branch_name]">
                        </div>
                      </div>
