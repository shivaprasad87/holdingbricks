      ...
      <div class="col-md-4">
        ...
        <script>
           ...
           var a=$(trid)[3];
             ...
             var weburl=   'https://'+window.location.host+'/sales/admin/lead_report?user_id='+userid+'&fromDate='+fromDate+'&toDate='+toDate
             console.log(weburl);
             var tbody='';
             var theadtr='';
             ...
             $.ajax({
                 "Type":"GET",
                  "url":' https://'+window.location.host+'/sales/admin/lead_report?user_id='+userid+'&fromDate='+fromDate+'&toDate='+toDate,
             ...
             var theadtr='';
                $.ajax({
                 "Type":"GET",
                 "url":' https://'+window.location.host+'/sales/admin/lead_report?user_id='+user_id+'&fromDate='+fromDate+'&toDate='+toDate+'&lead_source_id='+lead_source_id,
                  success: function (response) {
                      var data=JSON.parse(response)
                      console.log(data)
                      var thead= Object.keys(data[0])
                    ...
                    for(i=0;i<=data.length-1;i++){
                      var url_of_project = 'https://'+window.location.host+'/sales/admin/lead_report?user_id='+user_id+'&fromDate='+fromDate+'&toDate='+toDate+'&lead_source_id='+lead_source_id+'&project_id='+data[i].project_id;
