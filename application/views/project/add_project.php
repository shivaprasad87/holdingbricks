          ...
          <div class="col-md-12">
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                 <?php $attributes = array('class' => 'common_valid'); echo form_open("projects/new_project",$attributes); ?>
                     
                    <div class="row">
                      <div class="col-md-12 mt-4 mb-2">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Project Name <span class="text-danger">*</span></label>
                          <input type="text" class="form-control  validate[required] "  id="project_name" name="project[project_name]">
                        </div>
                      </div>
